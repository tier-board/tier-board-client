 ...
 render() {
   return(
     <div>
       ...
       {this.state.view && 
         <div>
           <DeliveryForm onComplete={this.deliveryUpdate} delivery={this.props.delivery} viewChange={this.returnView} onClick={this.props.returnView} buttonText = 'save update'/>
